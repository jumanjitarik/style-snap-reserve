...
export function TopBar() {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md px-3 py-1.5 flex items-center gap-2 bg-background/85 backdrop-blur-xl border-b border-primary/15">
        {!isHome && (
          <button
            onClick={() => router.history.back()}
            aria-label="Geri"
            className="shrink-0 rounded-full p-1.5 text-primary active:scale-90 transition hover:bg-primary/10"
          >
        ...
        {signedIn && (
          <div className="flex items-center gap-1">
            <Link to="/favoriler" aria-label="Favoriler" className="rounded-full p-1.5 text-primary active:scale-90 transition hover:bg-primary/10">
              <Heart className="h-6 w-6" />
            </Link>
            <Link to="/bildirimler" aria-label="Bildirimler" className="relative rounded-full p-1.5 text-primary active:scale-90 transition hover:bg-primary/10">
