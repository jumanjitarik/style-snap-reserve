...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "KuaförApp — Güzellik Bakım Randevu" },
      { name: "twitter:description", content: "Erkek ve Kadın kuaförü, lazer, tırnak, cilt ve estetik için online randevu." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/5426b235-3e5b-499a-a944-0da2533333e9" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/5426b235-3e5b-499a-a944-0da2533333e9" },
    ],
    links: [
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    return () => {
      mounted = false;
      (window as unknown as { __sb_sub?: { unsubscribe: () => void } }).__sb_sub?.unsubscribe();
    };
  }, [router, queryClient]);
